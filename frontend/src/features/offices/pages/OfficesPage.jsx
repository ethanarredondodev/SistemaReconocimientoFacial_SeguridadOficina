...
const OfficesPage = () => {
    ...
    return (
        <div>
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ color: "#888", fontSize: "14px" }}>
                        {offices.length} oficinas registradas
                    </p>
                </div>
                <button
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    ...
                    <tbody>
                        {offices.length === 0 ? (
                            ...
                            offices.map((office) => (
                                <tr key={office.id} style={{ borderBottom: "1px solid #f9f9f9" }}>
                                    ...
                                    <td style={{ padding: "14px 20px" }}>
                                        <span style={{
                                            ...
                                            fontSize: "12px",
                                            fontWeight: "600",
                                            background: office.is_active ? "#ebfbee" : "#f9f9f9",
                                            color: office.is_active ? "#40c057" : "#aaa"
                                        }}>
            ...
            {/* Modal Crear */}
            {modal === "create" && (
                <Modal title="Nueva oficina">
                    <OfficeForm onSubmit={handleCreate} onCancel={closeModal} />
                </Modal>
            )}

            {/* Modal Editar */}
            {modal === "edit" && selected && (
                <Modal title="Editar oficina">
                    <OfficeForm
            ...
            {modal === "delete" && selected && (
                <Modal title="Eliminar oficina">
                    <p style={{ color: "#555", marginBottom: "24px", fontSize: "14px" }}>
                        ¿Estás seguro que deseas desactivar la oficina <strong>{selected.name}</strong>?
                    </p>
